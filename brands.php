...
if($brand_id>0){
	$brand_product=brand_product($con,'','',$brand_id,$sort_order);
...
<div class="body__overlay"></div>
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="product_all.php">Products</a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                  <!--<span class="breadcrumb-item active">Brands</span>-->
                                  <a class="breadcrumb-item" href="brands.php?id=<?php echo $brand_product['0']['brands_id']?>"><?php echo $brand_product['0']['brands']?></a>
                                </nav>
                            </div>
                        </div>
                    </div>
        ...
        <section class="htc__product__grid bg__white ptb--100">
            <div class="container">
                <div class="row">
					<?php if(count($brand_product)>0){?>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="htc__product__rightidebar">
                            <div class="htc__grid__top">
                                <div class="htc__select__option">
                                    <select class="ht__select" onchange="sort_drop('<?php echo $brand_id?>','<?php echo SITE_PATH?>')" id="sort_id">
